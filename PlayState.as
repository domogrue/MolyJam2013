package
{
	...
	public class PlayState extends FlxState
	{
		...
		override public function create():void
		{
			...
			//playbar
			playerBar1 = new PlayBar(player1.x+16, player1.y + 192 + 128);
			playerBar2 = new PlayBar(player2.x + 16, player2.y + 192 + 128);
			
			pointer2 = new Pointer(playerBar2.x + 80 - 8, playerBar2.y + 32 + 4);
			...
			add(playerBar1);
			add(playerBar1.sweetSpot);
			add(playerBar2);
			add(playerBar2.sweetSpot);
			add(pointer2);
		}
	}
}
